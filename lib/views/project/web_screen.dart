              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Visibility(
                        visible: widget.project.urlWeb.isNotEmpty,
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                ...
                                onTap: () {
                                  _launchURL(Uri.parse(widget.project.urlWeb));
                                },
                                child: Text(
                                  widget.project.urlWeb,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Visibility(
                        visible: widget.project.typeWeb.isNotEmpty,
                        child: Padding(
                      ...
                      Visibility(
                        visible: widget.project.bddUsed.isNotEmpty,
                        child: Padding(
                          padding: EdgeInsets.only(top: 10.h),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                      ...
                      Visibility(
                        visible: widget.project.hostingUsed.isNotEmpty,
                        child: Padding(
                          padding: EdgeInsets.only(top: 10.h),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                      ...
                      Visibility(
                        visible: widget.project.securityUsed.isNotEmpty,
                        child: Padding(
                          padding: EdgeInsets.only(top: 10.h),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.start,
